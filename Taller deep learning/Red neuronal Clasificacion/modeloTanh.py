...
modelo_tanh = keras.Sequential([
    ...
    keras.layers.Dense(4, activation='tanh'),  # Capa oculta 1
    keras.layers.Dense(4, activation='tanh'),  # Capa oculta 2
    keras.layers.Dense(4, activation='tanh'),  # Capa oculta 3
    keras.layers.Dense(4, activation='tanh'),  # Capa oculta 4
    keras.layers.Dense(4, activation='tanh'),  # Capa oculta 5
